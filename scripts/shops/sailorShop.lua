...
function CheronShop:init()
    super.init(self)
    self.encounter_text = "* Hello again, my lost friends."
    ...
    self:registerTalk("Your daughter?")
    self:registerTalk("Your name?")
    self:registerTalk("Picture frame")
    self:registerTalk("The Evergroves")

    self:registerTalkAfter("Your daughter?", 1)
    self:registerTalkAfter("Your name?", 2, "talk_2", 1)
    self:registerTalkAfter("Picture frame", 2, "talk_3", 2)
    self:registerTalkAfter("The Evergroves", 2, "talk_3", 2)
end
